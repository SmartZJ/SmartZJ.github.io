import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as t,c as i,a as n,b as o,d as l,e as s}from"./app-179530ea.js";const c={},r=s(`<h1 id="vuepress博客搭建2默认主题配置" tabindex="-1"><a class="header-anchor" href="#vuepress博客搭建2默认主题配置" aria-hidden="true">#</a> vuepress博客搭建2默认主题配置</h1><h2 id="默认主题安装" tabindex="-1"><a class="header-anchor" href="#默认主题安装" aria-hidden="true">#</a> 默认主题安装</h2><p>创建项目只是第一步，想让博客网站更加完善还需要默认主题的帮助。</p><p>安装 <code>theme-default</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i @vuepress/theme-default
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>安装完成后在 <code>/docs/.vuepress/config.js</code>文件中做如下配置：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defaultTheme <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@vuepress/theme-default&#39;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">theme</span><span class="token operator">:</span> <span class="token function">defaultTheme</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    <span class="token comment">// 在这里进行主题配置</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>configs.js文件中修改</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defaultTheme <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@vuepress/theme-default&#39;</span>
...
<span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置好后页面是这样的</p><figure><img src="https://zj-imges-1257736100.cos.ap-chengdu.myqcloud.com/blog_img/sidebar配置.png" alt="配置后的侧边栏" tabindex="0" loading="lazy"><figcaption>配置后的侧边栏</figcaption></figure><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>			<span class="token punctuation">{</span>
                <span class="token literal-property property">text</span><span class="token operator">:</span><span class="token string">&#39;vuepress博客搭建(一)创建项目&#39;</span><span class="token punctuation">,</span>
                <span class="token literal-property property">link</span><span class="token operator">:</span><span class="token string">&#39;/frontend/vuepress/vuepress博客搭建(一)创建项目.md&#39;</span>
            <span class="token punctuation">}</span>
...
<span class="token punctuation">}</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每一组配置前都有一个<strong>key</strong>这是用于匹配路径前缀，这样当我们进入不同类型文章的文件夹下，侧边栏就会自动切换侧边栏配置，就像这样：</p><figure><img src="https://zj-imges-1257736100.cos.ap-chengdu.myqcloud.com/blog_img/sidebar2.png" alt="前端侧边栏" tabindex="0" loading="lazy"><figcaption>前端侧边栏</figcaption></figure><figure><img src="https://zj-imges-1257736100.cos.ap-chengdu.myqcloud.com/blog_img/sidebar1.png" alt="咖啡侧边栏" tabindex="0" loading="lazy"><figcaption>咖啡侧边栏</figcaption></figure><h3 id="页面配置" tabindex="-1"><a class="header-anchor" href="#页面配置" aria-hidden="true">#</a> 页面配置</h3><p>页面配置是在每个页面头部进行配置优先级大于全局配置，如果文章页面有配置侧边栏则该配置会直接覆盖全局配置，配置方法如下：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//md文件头部</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置参数参考全局配置，但我个人尝试发现text属性好像不怎么管用，所以就直接放文章的路径，此配置应该也不会常用做了解即可。</p><p>到此导航栏配置加上侧边栏配置基本使用就已经全部介绍了，简单的使用博客我个人觉得已经是够用了。更多功能就等我用一段时间再扩展吧。</p>`,49);function v(k,m){const a=p("ExternalLinkIcon");return t(),i("div",null,[r,n("p",null,[n("a",d,[o("主题配置文档"),l(a)])]),u])}const h=e(c,[["render",v],["__file","vuepress博客搭建2默认主题配置.html.vue"]]);export{h as default};
